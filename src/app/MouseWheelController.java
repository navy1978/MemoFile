...
/**
 * This class allows you to control the units scrolled for each mouse wheel rotation relative to the
 * unit increment value of the scroll bar. Specifying a scroll amount of 1, is equivalent to
 * clicking the unit scroll button of the scroll bar once.
 */
public class MouseWheelController implements MouseWheelListener {
  ...
  /**
   * Set the scroll amount. Controls the amount the scrollpane will scroll for each mouse wheel
   * rotation. The amount is relative to the unit increment value of the scrollbar being scrolled.
   *
   * @param scrollAmount an integer value. A value of zero will use the default scroll amount for
   *     your OS.
   */
